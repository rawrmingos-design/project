...
@section('content')
    ...
    <div class="relative h-56 w-full bg-murky-800 lg:h-[340px]">
        <x-optimized-image :src="$kategori->banner" profile="banner" alt="{{ $kategori->nama }}" sizes="100vw"
            loading="eager" fetchpriority="high" class="object-cover object-center"
        ...
        <ul class="circles">
            ...
            <section class="relative flex items-center overflow-hidden bg-secondary/50 px-4 py-m lg:min-h-[521.96px]">
                ...
                @for ($i = 0; $i < count($positions); $i++)
                    ...
                    @endphp
                    <span
                        class="absolute left-1/2 top-1/2 h-1 w-1 rotate-[215deg] animate-meteor-effect rounded-[9999px] bg-white shadow-[0_0_0_1px_#ffffff10] before:absolute before:top-1/2 before:h-[1px] before:w-[80px] before:-translate-y-[0%] before:transform before:bg-gradient-to-r before:from-white before:to-transparent before:content-['']"
        ...
        <div
            ...
            <article class="flex items-start gap-4">
                <div class="product-thumbnail-container"><x-optimized-image :src="$kategori->thumbnail" profile="thumbnail"
                        alt="{{ $kategori->nama }}" sizes="(min-width: 768px) 240px, 128px" width="240" height="240"
            ...
            <div class="ml-[8.5rem] pt-4 md:ml-[15.5rem] md:pt-5">
                ...
                <div class="flex items-center space-x-8 pt-4">
                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm">
                        <div class="rounded-full bg-emerald-500 p-1"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-3.5 w-3.5 text-white">
                    ...
                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm">
                        <div class="rounded-full bg-murky-500 p-1"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="container md:hidden">
        <div class="order-mobile-tabs" data-order-mobile-tabs>
            <button type="button" class="order-mobile-tab-btn is-active"
                data-mobile-tab-target="transaksi">Transaksi</button>
                ...
                <div class="rounded-xl bg-murky-800 shadow-2xl">
                    <div class="prose prose-sm px-4 py-2 pb-8 text-xs text-white sm:px-6">
                        ...
                        <div class="mt-2 flex flex-col border-t border-dashed  text-card-foreground">
                            <p> Note:&nbsp;<br> Jika Mengalami Kendala Silahkan hub CS IG <a
                                    href="{{ !$config ? '' : $config->url_ig }}" target="_blank">Instagram</a> dan CS
                                WhatsApp <a href="{{ !$config ? '' : $config->url_wa }}" target="_blank">WhatsApp</a></p>
                        </div>
                    ...
                    <div class="flex border-b border-murky-600">
                        <div class="flex flex-row items-center gap-1 bg-[#ffc007] text-darkColor rounded-md">
                            <div class="items-center justify-start flex bg-gradient-to-b from-murky-800 to-murky-800 clip-path-number p-4 h-12 w-16"
                                style="border-top-left-radius: 12px;"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flow-root p-6">
                        ...
                        <div class="flex flex-col overflow-hidden ">
                            <div class="mx-6 flex items-center justify-center gap-2">
                                ...
                                <div><span class="text-5xl text-besar">{{ number_format($averageRating, 1) }}</span> / 5.0
                                </div>
                            </div>
                            <div class="flex flex-col gap-1">
                                <div class="mx-6 flex items-center justify-center text-xs font-bold">
                                    {{ number_format($satisfactionPercentage, 0) }}% pembeli merasa puas dengan produk ini.
                                </div>
                                <div class="mx-6 flex items-center justify-center gap-2 text-xs">Dari {{ $totalReviews }}
                                    Ulasan.</div>
                            </div>
                        </div>
                                ...
                                <ul class="rating-list" style="list-style-type: none; padding-left: 0;">
                                    <li class="rating-item" style="display: flex; align-items: center; margin-bottom: 5px;">
                                        ...
                                        <div class="star-rating"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                                aria-hidden="true" style="height: 20px; width: 20px; color: #ffc107;">
                                                <path fill-rule="evenodd"
                                                    d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z"
                                                    clip-rule="evenodd"></path>
                                            </svg>
                                        ...
                                        <div class="bar"
                                            ...
                                            <div class="progress"
                                                style="height: 100%; background-color: #ffc107; border-radius: 5px; width: {{ $percentage }}%;">
                                            </div>
                                        </div>
                        ...
                        @else
                            <div class="mt-6">
                                <p class="text-sm text-secondary-foreground">Apakah kamu menyukai produk ini? Beri tahu kami dan
                                    calon pembeli lainnya tentang pengalamanmu.</p>
                            </div>
                            <hr>
                                                        ...
                                                        <div class="flex items-center">
                                                            @for($i = 1; $i <= 5; $i++)
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                                    fill="{{ $i <= $rating->bintang ? 'currentColor' : 'white' }}"
                                                                    aria-hidden="true" class="text-yellow-400 h-4 w-4 flex-shrink-0">
                                                                    <path fill-rule="evenodd"
                                                                        d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z"
                                                                        clip-rule="evenodd"></path>
                                                                </svg>
                        ...
                        <div class="flex justify-end pt-5 mt-5">
                            <a class="inline-flex items-center justify-center whitespace-nowrap text-xs font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent/75 hover:text-accent-foreground h-8 rounded-md px-4 bg-secondary/50 pr-3 flex items-center gap-2"
                                type="button" href="/id/reviews" style="outline: none;">
                ...
                <ul class="col-span-3 flex flex-col space-y-8 md:col-span-2" data-mobile-pane="transaksi">
                    <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-input">
                        ...
                        <div class="flex border-b border-murky-600">
                            <div class="flex flex-row items-center gap-1 bg-[#ffc007] text-darkColor rounded-md">
                                <div class="items-center justify-start flex bg-gradient-to-b from-murky-800 to-murky-800 clip-path-number p-4 h-12 w-16"
                                    style="border-top-left-radius: 12px;"><span class="font-bold text-xl italic">1</span></div>
                                <h3 class="px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">Masukkan Data Akun Kamu
                                </h3>
                            </div>
                        </div>
                                ...
                                @elseif($selectValue == "text" || $selectValue == "number" || $selectValue == "password")
                                    <div>
                                        ...
                                        <div class="flex flex-col items-start">
                                            <input
                                                class="relative block w-full appearance-none rounded-none border border-murky-600 bg-murky-700 px-3 py-2 text-xs text-white placeholder-murky-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 !rounded-md !border-0 !bg-murky-200 !text-murky-800 !placeholder-murky-800 accent-murky-800 !ring-0 placeholder:text-xs focus:!border-transparent focus:!bg-white focus:!ring-transparent"
                                                type="{{ $field2Values[2] }}" name="zone_id" id="zone"
                            ...
                            <div class="grid grid-cols-2 gap-4 p-4 sm:px-6 sm:pb-4">
                                <div>
                                    ...
                                    <div class="flex flex-col items-start">
                                        <input
                                            ...
                                            type="email" id="email_joki" name="email_joki" placeholder="Ketikan Email/No. Hp"
                                            required />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="PhoneInputInput relative block w-full appearance-none rounded-md border-0 bg-murky-200 px-3 py-2 text-xs text-murky-800 placeholder-murky-800 focus:z-10 focus:border-transparent focus:outline-none focus:ring-transparent focus:bg-white"
                                            type="password" id="password_joki" name="password_joki" placeholder="Ketikan Password"
                                            required />
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="PhoneInputInput relative block w-full appearance-none rounded-md border-0 bg-murky-200 px-3 py-2 text-xs text-murky-800 placeholder-murky-800 focus:z-10 focus:border-transparent focus:outline-none focus:ring-transparent focus:bg-white"
                                            type="text" id="nickname_joki" name="nickname_joki" placeholder="Ketikan Nickname"
                                            required />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="PhoneInputInput relative block w-full appearance-none rounded-md border-0 bg-murky-200 px-3 py-2 text-xs text-murky-800 placeholder-murky-800 focus:z-10 focus:border-transparent focus:outline-none focus:ring-transparent focus:bg-white"
                                            type="text" id="request_joki" name="request_joki"
                                            placeholder="Min Request 3 Hero (Diusahakan)" required />
                                    </div>
                                </div>
                                <div>
                                    <label for="catatan_joki" class="block text-xs font-medium text-white pb-2">Catatan untuk
                                        Penjoki</label>
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="PhoneInputInput relative block w-full appearance-none rounded-md border-0 bg-murky-200 px-3 py-2 text-xs text-murky-800 placeholder-murky-800 focus:z-10 focus:border-transparent focus:outline-none focus:ring-transparent focus:bg-white"
                                            type="text" id="catatan_joki" name="catatan_joki" placeholder="Catatan untuk Penjoki"
                                            required />
                                    </div>
                                </div>
                            </div>
                    ...
                    @if(in_array($kategori->tipe, ['joki']))
                        <div class="popup-structureeee popup-slide flex min-h-full items-center justify-center p-4 text-center sm:p-0"
                            id="popupdppp">
                            <div class="fixed inset-0 z-10 overflow-y-auto">
                                <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                                    <div class="popup-content relative w-full transform overflow-hidden rounded-lg bg-murky-900 text-left shadow-xl transition-all sm:my-8 sm:max-w-3xl !rounded-2xl opacity-100 sm:scale-100"
                                        ...
                                        <div class="w-full pb-4 flex flex-col items-center justify-center">
                                            <h2 class="max-w-xl pt-1 text-center text-sm font-semibold text-white mt-4">Informasi
                                                Sebelum Order Jasa Joki MLBB</h2>
                                            <div class="prose prose-sm px-2 text-xs text-foreground">
                                                <div>
                                                    <p><strong>
                                                            <em class="text-white">Mohon luangkan waktu untuk membaca catatan Informasi
                                                                sebelum melakukan pemesanan.<br /><br /></em>
                                                        </strong>Waktu Pengecekan Orderan :<br />Orderan yang sudah dibayarkan akan kami
                                                        cek setiap hari mulai pukul 10.00 - 22.00 WIB.<br />Untuk orderan yang melewati
                                                        batas waktu pengecekan, akan kami proses pada jam kerja di hari
                                                        berikutnya.<br /><br />Berikut Syarat Dan Ketentuan Sebelum Order Jasa Joki :
                                                    </p>
                                                    <p class="selectable-text copyable-text iq0m558w g0rxnol2" dir="ltr">
                                                        <span class="selectable-text copyable-text">1. Data Akun : Lengkapi data dengan
                                                            benar, termasuk kapitalisasi huruf.<br /></span>2. Pilihan Hero : Minimal
                                                        tiga pilihan hero, sebagai alternatif jika hero sedang di pick/ban.<br />
                                                        <span class="selectable-text copyable-text">3. Verifikasi Akun : Nonaktifkan
                                                            Untuk Mempermudah Login.<br /></span>
                                                        <span class="selectable-text copyable-text">4. Tipe Akun : Utamakan Akun yang
                                                            dijoki adalah akun utama, bukan akun beli atau bekas GB untuk menghindari
                                                            BAN.<br /></span>
                                                        <span class="selectable-text copyable-text">5. Login Tanpa izin : Berakibat
                                                            pembatalan joki dan hangusnya pembayaran.<br /></span>
                                                        <span class="selectable-text copyable-text">6. Kesabaran: Tunggu sesuai estimasi
                                                            dan jangan spam chat admin.<br /></span>
                                                        <span class="selectable-text copyable-text">7. Masalah Login : Admin/Bot akan
                                                            menghubungi jika ada kendala.<br /></span>
                                                        <span class="selectable-text copyable-text">8. Keterlambatan Proses : Hubungi
                                                            kami jika belum diproses dalam 1-3 jam.<br /></span>
                                                        <span class="selectable-text copyable-text">9. Setelah Joki Selesai : Tetapi
                                                            belum menerima laporan dari Admin/BOT, jangan di login terlebih dahulu
                                                            karena ada benefit bonus.<br /></span>
                                                        <span class="selectable-text copyable-text">10. Tanggung Jawab Pasca-Joki :
                                                            Tanggung jawab atas akun berakhir setelah joki selesai.<br /></span>
                                                        <span class="selectable-text copyable-text">11. Konfirmasi Selesai : Akan
                                                            dihubungi oleh Admin/BOT dan Customer Bisa Cek Malalui (Cek
                                                            Transaksi)<br /><br /></span>
                                            ...
                                            <div class="flex justify-center bg-secondary px-4 py-2 rounded-xl">
                                                <button
                                                    ...
                                                    type="button" name="popup" id="closeJokiInfoPopupButton">
                                                    OK, Saya Mengerti
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-nominal">
                        <div class="flex border-b border-murky-600">
                            <div
                                class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-400 to-primary-600 px-3 py-2 text-xl font-semibold">
                                2 </div>
                            <h3
                                class="flex w-full items-center text-sm/6 justify-between rounded-tr-xl bg-gradient-to-b from-murky-800 to-murky-800 px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">
                                Pilih Nominal </h3>
                        </div>
                        <div id="skeleton-loader"
                            class="skeleton-loader grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 px-4 mt-4 py-4">
                            @for ($i = 0; $i < 12; $i++)
                                ...
                                <div x-show="selectedPaket === 'all'">
                                    @foreach($pakets as $paket)
                                        <section">
                                            ...
                                            <div id="radiogroup-{{ $loop->index }}" role="radiogroup"
                                                ...
                                                <div id="specialList"
                                                    ...
                                                    @foreach(collect($paket['layanan'])->sortBy('harga') as $nom)
                                                        <div x-bind:class="{ 'ring-2 ring-primary-500 ring-offset-2 ring-offset-murky-800 duration-300 ease-in-out': selectedProduct === '{{ $nom['id'] }}', 'bg-murky-200': selectedProduct !== '{{ $nom['id'] }}' }"
                                                            ...
                                                            id="product-{{ $nom['id'] }}" product-id="{{ $nom['id'] }}" role="radio"
                                                            aria-checked="false" name="nominal" value="{{ $nom['id'] }}" tabindex="0"
                                                            aria-labelledby="label-{{ $nom['id'] }}"
                                                            aria-describedby="description-{{ $nom['id'] }}"
                                                            @click="selectedProduct = '{{ $nom['id'] }}'">
                                                            <input type="radio" name="nominal" value="{{ $nom['id'] }}"
                                                                class="peer hidden" />
                                                            @php
                                                                $currentDateTime = now();
                                                            @endphp
                                                            ...
                                                            <span class="flex flex-1">
                                                                <span class="flex flex-col justify-between">
                                                                    <span class="trunc block text-xs text-murky-800 font-semibold"
                                                                        id="namalayanan">{{ $nom['layanan'] }}</span>
                                                                    <div>
                                                                        @if($nom['is_flash_sale'] == 1 && $nom['expired_flash_sale'] >= $currentDateTime)
                                                                            <span
                                                                                class="mt-1 flex items-center text-xs font-semibold text-murky-600 harga">Rp&nbsp;{{ number_format($nom['harga_flash_sale'], 0, ',', '.') }}</span>
                                                                            <span
                                                                                class="flex items-center text-xs font-semibold italic line-through decoration-[0.9px] text-murky-600 decoration-destructive">Rp&nbsp;{{ number_format($nom['harga'], 0, ',', '.') }}</span>
                                                                        @else
                                                                            <span
                                                                                class="mt-1 flex items-center text-xs font-semibold text-murky-600 harga">Rp&nbsp;{{ number_format($nom['harga'], 0, ',', '.') }}</span>
                                                                        @endif
                                                                    </div>
                                                                </span>
                                                                ...
                                                                @if($nom['is_flash_sale'] == 1 && $nom['expired_flash_sale'] >= $currentDateTime)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="absolute block w-square-diagonal py-1 text-center text-xxs font-semibold uppercase bottom-0 right-0 rotate-45 origin-bottom-right shadow-sm bg-orange-500 text-foreground">
                                                                            {{ number_format(($nom['harga'] - $nom['harga_flash_sale']) / $nom['harga'] * 100, 0) }}%
                                                                            OFF
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                            ...
                                                            @if($nom['product_logo'])
                                                                <div class="flex aspect-square w-8 items-center">
                                                                    <x-optimized-image :src="$nom['product_logo']" profile="product_logo"
                                                                        alt="{{ $nom['layanan'] }}" sizes="160px" width="300" height="300"
                                                                        class="object-contain object-right" style="color: transparent;" />
                                                                </div>
                                                            @endif
                                                            <div
                                                                x-bind:class="{ 'block': selectedProduct === '{{ $nom['id'] }}', 'hidden': selectedProduct !== '{{ $nom['id'] }}' }">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                        ...
                        <div class="rounded-xl bg-murky-800 shadow-2xl" id="quantity">
                            ...
                            <div class="flex border-b border-murky-600">
                                <div
                                    ...
                                    3 </div>
                                <h3
                                    class="flex w-full items-center justify-between text-sm/6 rounded-tr-xl bg-gradient-to-b from-murky-800 to-murky-800 px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">
                                    Jumlah Pembelian </h3>
                            </div>
                                ...
                                <div class="flex items-center gap-x-4">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" id="incrementBtn"
                                            class="flex items-center justify-center rounded-md bg-murky-200 p-1.5 text-murky-800 disabled:cursor-not-allowed disabled:opacity-75">
                                        ...
                                        <div x-bind:class="{ 'bg-white bj-shadow': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                            ...
                                            <div class="flex items-center gap-2 max-w-xs">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="block text-xxs text-murky-800 sm:text-xs hargapembayaran" id="{{$p->code}}">Rp 0
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="max-w-xs">
                                    ...
                                    <div x-bind:class="{ 'bg-white bj-shadow': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                        ...
                                        <div class="flex items-center gap-2 max-w-xs">
                                            <input type="radio" id="method_{{$p->id}}" name="paymentMethod" value="{{$p->code}}"
                                                class="peer hidden" />
                                            <label for="method_{{$p->id}}"></label>
                                            <x-optimized-image :src="$p->image_url" profile="payment_logo" alt="qris" sizes="55px"
                                                width="55" height="40" />
                                            <div>
                                                <span class="block font-bjcredits text-xs font-semibold text-murky-800 sm:text-sm"
                                                    id="headlessui-label-:riu:">{{$p->name}}</span>
                                                <p class="block text-xxs text-murky-800 sm:text-xs hargapembayaran" id="{{$p->code}}">Rp 0
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="flex w-full transform flex-col justify-between rounded-xl bg-murky-600 text-left text-sm font-medium text-white duration-300 focus:outline-none accordion-header"
                                ...
                                <dt>
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700 " x-ref="container1"
                                        x-bind:style="selected == 3 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : 'max-height: 0'"
                                        ...
                                        <div class="px-4 pt-2 pb-4 text-sm text-murky-300" id="disclosure-panel-1">
                                            <div id="radiogroup-1" role="radiogroup" aria-labelledby="label-1">
                                                <div id="eWalletList"
                                                    ...
                                                    role="none"> @foreach($pay_method as $p) @if($p->isType('e-walet'))
                                                        <div x-bind:class="{ 'bg-white bj-shadow ring-2 ring-primary-500 ring-offset-2 ring-offset-murky-800 duration-300 ease-in-out': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                                            method-id="{{$p->code}}"
                                                            ...
                                                            id="radio-group-{{$p->code}}" role="radio" aria-checked="false"
                                                            method-id="{{$p->code}}" id="method_{{$p->id}}" name="paymentMethod"
                                                            value="{{$p->code}}" tabindex="0" aria-labelledby="label-{{$p->code}}:"
                                                            aria-describedby="description-{{$p->code}}"
                                                            @click="paymentSelected = '{{$p->code}}'">
                                                            <input type="radio" id="method_{{$p->id}}" name="paymentMethod"
                                                                value="{{$p->code}}" class="peer hidden" />
                                                            <label for="method_{{$p->id}}"></label>
                                                            <span class="flex w-full">
                                                                <span class="flex w-full flex-col justify-between">
                                                                    <div>
                                                                        ...
                                                                        <span
                                                                            class="mt-0 flex items-center text-xxs text-murky-600">{{$p->keterangan}}</span>
                                                                        <hr>
                                                                    </div>
                                                                    <div class="flex w-full items-center justify-between">
                                                                        ...
                                                                        <div class="relative aspect-[6/2] w-10">
                                                                            <x-optimized-image :src="$p->image_url"
                                                                                profile="payment_logo" alt="{{ $p->name }}"
                                                                                sizes="160px"
                                                                                x-bind:class="{ 'grayscale-0': paymentSelected === '{{$p->code}}', 'grayscale': paymentSelected !== '{{$p->code}}' }"
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 w-full rounded-b-md bg-murky-300"
                                        ...
                                        <div class="flex justify-end gap-x-2"> @foreach($pay_method as $p)
                                            @if($p->isType('e-walet'))
                                                <div class="relative aspect-[6/2] w-10">
                                                    <x-optimized-image :src="$p->image_url" profile="payment_logo" alt="{{ $p->name }}"
                                                        sizes="160px" class="object-scale-down"
                                                        style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;" />
                                        </div> @endif @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="flex w-full transform flex-col justify-between rounded-xl bg-murky-600 text-left text-sm font-medium text-white duration-300 focus:outline-none accordion-header"
                                ...
                                <dt>
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700" x-ref="container2"
                                        x-bind:style="selected == 5 ? 'max-height: ' + $refs.container2.scrollHeight + 'px' : 'max-height: 0'"
                                        style="max-height: 239px;">
                                        <div class="px-4 pt-2 pb-4 text-sm text-murky-300" id="disclosure-panel-2">
                                            <div id="radiogroup-2" role="radiogroup" aria-labelledby="label-2">
                                                <div id="virtualAccountList"
                                                    class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-2 xl:grid-cols-3"
                                                    role="none"> @foreach($pay_method as $p) @if($p->isType('virtual-account'))
                                                        <div x-bind:class="{ 'bg-white bj-shadow ring-2 ring-primary-500 ring-offset-2 ring-offset-murky-800 duration-300 ease-in-out': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                                            method-id="{{$p->code}}"
                                                            class="method-list relative flex cursor-pointer overflow-hidden payment-method rounded-xl border border-transparent p-2.5 shadow-sm outline-none md:p-4 bg-white bj-shadow hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-800 duration-300 ease-in-out"
                                                            id="radio-group-{{$p->code}}" role="radio" aria-checked="false"
                            ...
                            <div class="flex w-full transform flex-col justify-between rounded-xl bg-murky-600 text-left text-sm font-medium text-white duration-300 focus:outline-none accordion-header"
                                ...
                                <dt>
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700" x-ref="container3"
                                        x-bind:style="selected == 4 ? 'max-height: ' + $refs.container3.scrollHeight + 'px' : 'max-height: 0'"
                                        style="max-height: 239px;">
                                        <div class="px-4 pt-2 pb-4 text-sm text-murky-300" id="disclosure-panel-3">
                                            <div id="radiogroup-3" role="radiogroup" aria-labelledby="label-3">
                                                <div id="convenienceStoreList"
                                                    class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-2 xl:grid-cols-3"
                                                    role="none"> @foreach($pay_method as $p) @if($p->isType('convenience-store'))
                                                        <div x-bind:class="{ 'bg-white bj-shadow ring-2 ring-primary-500 ring-offset-2 ring-offset-murky-800 duration-300 ease-in-out': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                                            method-id="{{$p->code}}"
                                                            class="method-list relative flex cursor-pointer overflow-hidden payment-method rounded-xl border border-transparent p-2.5 shadow-sm outline-none md:p-4 bg-white bj-shadow hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-800 duration-300 ease-in-out"
                                                            id="radio-group-{{$p->code}}" role="radio" aria-checked="false"
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="grow">
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="PhoneInputInput relative block w-full appearance-none rounded-md border-0 bg-murky-200 px-3 py-2 text-xs text-murky-800 placeholder-murky-800 focus:z-10 focus:border-transparent focus:outline-none focus:ring-transparent focus:bg-white"
                                            type="text" id="voucher" name="voucher" placeholder="Masukkan Kode Promo Anda"
                                            required />
                                    </div>
                                </div>
                    ...
                    <div class="rounded-xl bg-murky-800 shadow-2xl jumpToWhatsApp" id="whatsappp">
                        ...
                        <div class="flex border-b border-murky-600">
                            <div
                                ...
                                6 </div>
                            <h3
                                class="flex w-full items-center justify-between rounded-tr-xl text-sm/6 bg-gradient-to-b from-murky-800 to-murky-800 px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">
                                No. WhatsApp </h3>
                        </div>
                        <div class="p-4 sm:px-6">
                            ...
                            <div class="PhoneInput">
                                ...
                                <input type="number" id="nomor" autocomplete="off" name="whatsapp" placeholder="Contoh 08213456789"
                                    class="PhoneInputInput relative block w-full appearance-none rounded-md border-0 bg-murky-200 px-3 py-2 text-xs text-murky-800 placeholder-murky-800 focus:z-10 focus:border-transparent focus:outline-none focus:ring-transparent focus:bg-white"
                    ...
                    <div
                        class="inset-x-0 bottom-0 z-10  !mt-0 shad sticky bottom-0 rounded-t-lg pb-4 flex flex-col gap-4 bg-background">
                        <div class=" space-y-0">
                            <div class="rounded-lg border border-dashed bg-secondary p-2 text-sm  rounded-lg md:hidden initial-element"
                                style="display: flex;">
                            ...
                            <div class="rounded-lg border border-dashed bg-secondary p-2 text-sm text-secondary-foreground md:hidden selected-element "
                                ...
                                <div class="mb-1 aspect-square timmel-5">
                                    <x-optimized-image :src="$kategori->thumbnail" profile="thumbnail" alt="icon" sizes="80px"
                                        width="80" height="100" class="aspect-square timmel-5 rounded-lg object-cover"
                            ...
                            <div class="relative">
                                <button
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="lucide lucide-shopping-bag h-4 w-4">
                    ...
                    <div class="mt-4 block rounded-xl bg-murky-800 shadow-2xl md:hidden">
                        <div class="flex border-b border-murky-600">
                            <div
                                class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b bg-primary-500  to-primary-600 px-3 py-2 text-xl font-semibold">
                        ...
                        <div class="flow-root p-6">
                            ...
                            <div class="flex flex-col  overflow-hidden ">
                                <div class="mx-6 flex items-center justify-center gap-2">
                                    ...
                                    <div><span class="text-5xl text-besar">{{ number_format($averageRating, 1) }}</span> <span> /
                                        </span><span>5.0</span></div>
                                </div>
                                <div class="flex flex-col gap-1">
                                ...
                                @foreach($totalRatings as $rating => $count)
                                    ...
                                    <ul class="rating-list" style="list-style-type: none; padding-left: 0;">
                                        <li class="rating-item" style="display: flex; align-items: center; margin-bottom: 5px;">
                                            ...
                                            <div class="count" style="width: 50px; margin-left: 0px; text-align: right;">{{ $count }}
                                            </div>
                                        </li>
                                    </ul>
                ...
                <ul class="col-span-3 flex flex-col space-y-8 md:col-span-2" data-mobile-pane="transaksi">
                    <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-input">
                        ...
                        @elseif(in_array($kategori->tipe, ['jokigendong']))
                            ...
                            <div class="grid grid-cols-2 gap-4 p-4 sm:px-6 sm:pb-4">
                                <div>
                                    <label for="nickname_joki" class="block text-xs font-medium text-white pb-2">User ID & Nick
                                        Name</label>
                                    <div class="flex flex-col items-start">
                                        <input
                                            ...
                                            type="text" id="nickname_joki" name="nickname_joki" placeholder="User ID & Nick Name"
                                            required />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="relative block w-full appearance-none rounded-none border border-murky-600 bg-murky-700 px-3 py-2 text-xs text-black placeholder-murky-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 !rounded-md !border-0 !bg-murky-200 !text-murky-800 !placeholder-murky-800 accent-murky-800 !ring-0 placeholder:text-xs focus:!border-transparent focus:!bg-white focus:!ring-transparent"
                                            type="text" id="tglmain_joki" name="tglmain_joki" placeholder="Ketikan Tanggal Main"
                                            required />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="relative block w-full appearance-none rounded-none border border-murky-600 bg-murky-700 px-3 py-2 text-xs text-black placeholder-murky-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 !rounded-md !border-0 !bg-murky-200 !text-murky-800 !placeholder-murky-800 accent-murky-800 !ring-0 placeholder:text-xs focus:!border-transparent focus:!bg-white focus:!ring-transparent"
                                            type="text" id="jambooking_joki" name="jambooking_joki" placeholder="Ketikan Jam Booking"
                                            required />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="relative block w-full appearance-none rounded-none border border-murky-600 bg-murky-700 px-3 py-2 text-xs text-black placeholder-murky-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 !rounded-md !border-0 !bg-murky-200 !text-murky-800 !placeholder-murky-800 accent-murky-800 !ring-0 placeholder:text-xs focus:!border-transparent focus:!bg-white focus:!ring-transparent"
                                            type="text" id="catatan_joki" name="catatan_joki"
                                            placeholder="Ketikan Catatan Untuk Penjoki" required />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-payment-channel">
                        ...
                        <dl id="paymentList" class="flex w-full flex-col space-y-4 p-4 sm:p-6 hidden"
                            ...
                            @foreach($pay_method as $p)
                                @if($p->isType('qris'))
                                    <div x-bind:class="{ 'bg-white bj-shadow': paymentSelected === '{{$p->name}}', 'bg-murky-200': paymentSelected !== '{{$p->name}}' }"
                                        class="relative flex cursor-pointer method-list rounded-xl border border-transparent bg-murky-200 p-4 shadow-sm outline-none md:p-4 hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-800 duration-300 ease-in-out"
                                        role="radio" aria-checked="false" method-id="{{$p->name}}" name="paymentMethod"
                                        @click="paymentSelected = '{{$p->name}}'">
                                        <div class="flex items-center gap-2 max-w-xs">
                                            <input type="radio" id="method_{{$p->id}}" name="paymentMethod" value="{{$p->name}}"
                                                class="peer hidden" />
                                            <label for="method_{{$p->id}}"></label>
                                            <x-optimized-image :src="$p->image_url" profile="payment_logo" alt="qris" sizes="55px"
                                                width="55" height="40" />
                                            <div>
                                                <span class="block font-bjcredits text-xs font-semibold text-murky-800 sm:text-sm"
                                                    id="headlessui-label-:riu:">{{$p->name}}</span>
                                                <p class="block text-xxs text-murky-800 sm:text-xs hargapembayaran" id="{{$p->name}}">Rp 0
                                                </p>
                                            </div>
                                        </div>
                                        <div class="max-w-xs">
            ...
            @elseif($kategori->tipe === 'giftskin')
                ...
                <ul class="col-span-3 flex flex-col space-y-8 md:col-span-2" data-mobile-pane="transaksi">
                    <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-input">
                                ...
                                @elseif($selectValue == "text" || $selectValue == "number" || $selectValue == "password")
                                    <div>
                                        ...
                                        <div class="flex flex-col items-start">
                                            <input
                                                class="relative block w-full appearance-none rounded-none border border-murky-600 bg-murky-700 px-3 py-2 text-xs text-white placeholder-murky-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 !rounded-md !border-0 !bg-murky-200 !text-murky-800 !placeholder-murky-800 accent-murky-800 !ring-0 placeholder:text-xs focus:!border-transparent focus:!bg-white focus:!ring-transparent"
                                                type="{{ $field2Values[2] }}" name="zone_id" id="zone" placeholder="{{ $field2Values[1] }}"
                        ...
                        @elseif(in_array($kategori->tipe, ['giftskin']))
                            ...
                            <div class="grid grid-cols-2 gap-4 p-4 sm:px-6 sm:pb-4">
                                ...
                                <div>
                                    <label for="catatan_joki" class="block text-xs font-medium text-white pb-2">Nama
                                        Skin/Item/Kharisma</label>
                                    <div class="flex flex-col items-start">
                                        <input
                                            class="relative block w-full appearance-none rounded-none border border-murky-600 bg-murky-700 px-3 py-2 text-xs text-black placeholder-murky-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 !rounded-md !border-0 !bg-murky-200 !text-murky-800 !placeholder-murky-800 accent-murky-800 !ring-0 placeholder:text-xs focus:!border-transparent focus:!bg-white focus:!ring-transparent"
                                            type="text" id="catatan_joki" name="catatan_joki"
                                            placeholder="Ketikan Nama Skin/Item/Kharisma" required />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-payment-channel">
                        <div class="flex border-b border-murky-600">
                            <div
                                class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-400 to-primary-600 px-4 py-2 text-xl font-semibold">
                                3 </div>
                            <h3
                                class="flex w-full items-center justify-between rounded-tr-xl bg-gradient-to-b from-murky-800 to-murky-800 px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">
                                Pilih Metode Pembayaran </h3>
                        </div>
                        <dl id="paymentList" class="flex w-full flex-col space-y-4 p-4 sm:p-6"
                            x-data="{ selected: null, paymentSelected: '' }">
                                ...
                                <div class="flex items-center gap-2 max-w-xs">
                                    ...
                                    @foreach($pay_method as $p)
                                        @if($p->tipe == 'SALDO')
                                            <div>
                                                <span class="block font-bjcredits text-xs font-semibold text-murky-800 sm:text-sm"
                                                    id="headlessui-label-:riu:">FIstore COIN</span>
                                                <p class="block text-xxs text-murky-800 sm:text-xs" id="{{$p->code}}">Rp 0</p>
                                            </div>
                                        @endif
                                    @endforeach
                            ...
                            <div class="flex w-full transform flex-col justify-between rounded-xl bg-murky-600 text-left text-sm font-medium text-white duration-300 focus:outline-none accordion-header"
                                ...
                                <dt>
                                    ...
                                    <button class="w-full disabled:opacity-75" id="disclosure-button-:rbb:" type="button"
                                        @click="selected !== 7 ? selected = 7 : selected = null" aria-expanded="false"
                                        aria-controls="disclosure-panel-:rc8:">
                                        <div class="flex w-full justify-between px-4 py-2">
                                            <span class="transform text-base font-medium leading-7 duration-300">
                                                <div>QRIS</div>
                                            </span>
                                            <span class="ml-6 flex h-7 items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" aria-hidden="true"
                                                    class="h-6 w-6 transform duration-300"
                                                    x-bind:class="selected == 7 ? 'rotate-180' : 'rotate-0'">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        d="M19.5 8.25l-7.5 7.5-7.5-7.5"></path>
                                                </svg>
                                            </span>
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700" x-ref="container1"
                                        x-bind:style="selected == 7 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : 'max-height: 0'"
                                        style="max-height: 239px;">
                                        <div class="px-4 pt-2 pb-4 text-sm text-murky-300" id="disclosure-panel-1">
                                            <div id="radiogroup-1" role="radiogroup" aria-labelledby="label-1">
                                                <div id="eWalletList"
                                                    class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-2 xl:grid-cols-3"
                                                    role="none"> @foreach($pay_method as $p) @if($p->isType('qris'))
                                                        <div x-bind:class="{ 'bg-white bj-shadow ring-2 ring-primary-500 ring-offset-2 ring-offset-murky-800 duration-300 ease-in-out': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                                            method-id="{{$p->code}}"
                                                            class="method-list relative flex cursor-pointer overflow-hidden payment-method rounded-xl border border-transparent p-2.5 shadow-sm outline-none md:p-4 bg-white bj-shadow hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-800 duration-300 ease-in-out "
                                                            id="radio-group-{{$p->code}}" role="radio" aria-checked="false"
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 w-full rounded-b-md bg-murky-300"
                                        x-ref="logo3" x-bind:style="selected == 7 ? 'max-height: 0' : 'max-height: 30px'"
                                        x-bind:class="selected == 7 ? 'px-0 py-0' : 'px-4 pt-2.5 pb-5'">
                                        <div class="flex justify-end gap-x-2"> @foreach($pay_method as $p) @if($p->isType('qris'))
                                            <div class="relative aspect-[6/2] w-10">
                                                <x-optimized-image :src="$p->image_url" profile="payment_logo" alt="{{ $p->name }}"
                                                    sizes="160px" class="object-scale-down"
                                                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;" />
                    ...
                    <div class="rounded-xl bg-murky-800 shadow-2xl" id="promooo">
                        <div class="flex border-b border-murky-600">
                            <div
                                class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b bg-primary-500  px-4 py-2 text-xl font-semibold">
                                5</div>
                            <h3
                                class="flex w-full items-center justify-between rounded-tr-xl bg-gradient-to-b from-murky-800 to-murky-800 px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">
                                Kode Promo</h3>
                    ...
                    <div class="sticky inset-x-0 bottom-0 z-10 -mx-4 !mt-0">
                        <div class="container space-y-0 py-3">
                            <div class="flex items-start justify-start space-x-2 bg-secondary py-2 px-4 rounded-xl md:hidden initial-element"
                                style="display: flex;">
                                <div class="flex w-full flex-col space-y-0">
                                    <div class="rounded-md p-4">
                                        <div class="flex">
                            ...
                            <div class="flex items-start justify-start space-x-2 rounded-lg  p-4 text-sm bg-secondary md:hidden selected-element"
                                style="display: none;">
                                <div class="mb-1 aspect-square timmel-5">
                                    <x-optimized-image :src="$kategori->thumbnail" profile="thumbnail" alt="icon" sizes="80px"
                                        width="80" height="100" class="aspect-square timmel-5 rounded-lg object-cover"
                                ...
                                <div class="flex w-full flex-col space-y-1">
                                    <div class="text-xs cana select glowing-text selected-order"> Pilih layanan terlebih dahulu
                                    </div>
                                    <div class="flex items-center gap-2 pt-0.5 font-semibold">
                            ...
                            <div class="relative">
                                <button
                                    class="inline-flex items-center justify-center rounded-md bg-primary-500 px-4 py-2 text-sm font-medium text-white duration-300 hover:bg-primary-500 disabled:cursor-not-allowed disabled:opacity-75 btn-order relative flex w-full gap-2 overflow-hidden"
                                    type="button" id="order-check">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="lucide lucide-shopping-bag h-4 w-4">
                    ...
                    <div class="mt-4 block rounded-xl bg-murky-800 shadow-2xl md:hidden">
                        <div class="flex border-b border-murky-600">
                            <div
                                class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b bg-primary-500  to-primary-600 px-4 py-2 text-xl font-semibold">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
                                    class="h-4 w-4">
                                    <path fill-rule="evenodd"
                                        d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z"
                            ...
                            <h3
                                class="flex w-full items-center justify-between rounded-tr-xl bg-gradient-to-b to-murky-800 px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">
                                Ulasan</h3>
                        </div>
                                ...
                                @foreach($totalRatings as $rating => $count)
                                    ...
                                    <ul class="rating-list" style="list-style-type: none; padding-left: 0;">
                                        <li class="rating-item" style="display: flex; align-items: center; margin-bottom: 5px;">
                                            ...
                                            <div class="count" style="width: 50px; margin-left: -25px; text-align: right;">{{ $count }}
                                            </div>
                                        </li>
                                    </ul>
                                @endforeach
            ...
            <ul class="col-span-3 flex flex-col space-y-8 md:col-span-2" data-mobile-pane="transaksi">
                        ...
                        <div class="grid grid-cols-2 gap-4 p-4 sm:px-6 sm:pb-4">
                            <div><label for="user_id"
                                ...
                                <div class="flex flex-col items-start"><input
                                        ...
                                        type="{{ $field1Values[2] }}" id="user_id" name="user_id"
                                        placeholder="{{ $field1Values[1] }}" /></div>
                            </div>
                            @if($selectValue == "select")
                                <div><label for="zone" class="block text-xs font-medium text-white pb-2">
                                        {{ $field2Values[0] }}</label><select
                                        class="relative block w-full appearance-none border border-murky-600 bg-melpa-800 px-3 py-2 text-xs text-white placeholder-murky-200 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-75 rounded-md"
                                        id="zone">
                                        <option value="">{{ $field2Values[1] }}</option> @foreach($fieldSelectTitle as $key => $fst)
                                        <option value="{{ $fieldSelect[$key] }}">{{ $fst }}</option>@endforeach
                                    </select></div>
                            @elseif($selectValue == "text" || $selectValue == "number" || $selectValue == "password")
                ...
                <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-nominal">
                    <div class="flex border-b border-murky-600">
                        <div class="flex flex-row items-center gap-1 bg-[#ffc007] text-darkColor rounded-md">
                            <div class="items-center justify-start flex bg-gradient-to-b from-murky-800 to-murky-800 clip-path-number p-4 h-12 w-16"
                                style="border-top-left-radius: 12px;"><span class="font-bold text-xl italic">2</span></div>
                                                ...
                                                @foreach(collect($paket['layanan'])->sortBy('harga') as $nom)
                                                    <div x-bind:class="{ 'ring-2 ring-primary-500 ring-offset-2 ring-offset-murky-800 duration-300 ease-in-out': selectedProduct === '{{ $nom['id'] }}', 'bg-murky-200': selectedProduct !== '{{ $nom['id'] }}' }"
                                                        ...
                                                        <span class="flex flex-1">
                                                            ...
                                                            @if($nom['is_flash_sale'] == 1 && $nom['expired_flash_sale'] >= $currentDateTime)
                                                                <div class="populaasdasdasdawrwr-t4124t3523ag-con42324124tainer3p423ath">
                                                                    <div class="popular-tag-content"><img src="/assets/image/discc.gif"
                                                                            alt="discount" class="h-5 w-5 "
                                                                            style="filter: drop-shadow(rgba(255, 255, 255, 0.5) 0px 0px 0.75rem);" />
                        ...
                        <div class="fixed inset-0 z-10 overflow-y-auto">
                            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                                <div class="relative w-full transform overflow-hidden rounded-lg bg-murky-900 text-left shadow-xl transition-all sm:my-8 sm:max-w-3xl !rounded-2xl opacity-100 translate-y-0 sm:scale-100"
                                    ...
                                    <div class="w-full pb-4 flex flex-col items-center justify-center">
                                        <h2 class="max-w-xl pt-1 text-center text-sm font-semibold text-white mt-4">WEEKLY DIAMOND
                                            PASS</h2>
                                        <div class="object-center mt-4 flex items-center justify-center">
                                            <img src="/assets/image/wdp.webp" class="object-center"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <p class="selectable-text copyable-text iq0m558w g0rxnol2" dir="ltr"><span
                                                            class="selectable-text copyable-text">Informasi Penting Sebelum
                                                            Pembelian Weekly Daily Pass</span></p>
                                                    <p class="selectable-text copyable-text iq0m558w g0rxnol2" dir="ltr">
                                                        <span class="selectable-text copyable-text g33ro0j9 ag95hn57">1.</span><span
                                                            class="selectable-text copyable-text"> Batas Maksimal Pembelian:
                                                            Pembelian tidak diizinkan jika telah melebihi batas 70
                                                            hari.<br /></span>
                                                        <span class="selectable-text copyable-text g33ro0j9 ag95hn57">2.</span><span
                                                            class="selectable-text copyable-text"> Kuota Pembelian: Perhatikan kuota
                                                            tersedia. Contoh: (5/10) berarti Anda dapat membeli 5 kali
                                                            lagi.<br /></span>
                                                        <span class="selectable-text copyable-text g33ro0j9 ag95hn57">3.</span>
                                                        <span class="selectable-text copyable-text"> Bonus dari Pembelian: Setiap
                                                            pembelian Weekly Diamond Pass menyelesaikan misi topup 100 dan langsung
                                                            memberikan 80 Diamonds.<br /></span>
                                                        ...
                                                        <span class="selectable-text copyable-text"> Kebijakan Refund: Jika
                                                            pembelian dilakukan setelah mencapai batas maksimal (0/10), uang akan
                                                            dikembalikan 90% sebagai konsekuensi.</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex justify-center bg-secondary px-4 py-2 rounded-xl">
                                            <button
                                                class="inline-flex items-center justify-center whitespace-nowrap text-xs font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-8 "
                                                type="button" name="popup" id="closeWeeklyDiamondPopupButton">
                                                OK, Saya Mengerti
                                            </button>
                                        </div>
                ...
                <div class="rounded-xl bg-murky-800 shadow-2xl" id="section-payment-channel">
                    <div class="flex border-b border-murky-600">
                        <div class="flex flex-row items-center gap-1 bg-[#ffc007] text-darkColor rounded-md">
                            <div class="items-center justify-start flex bg-gradient-to-b from-murky-800 to-murky-800 clip-path-number p-4 h-12 w-16"
                                style="border-top-left-radius: 12px;"><span class="font-bold text-xl italic">3</span></div>
                            <h3 class="px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">Pilih Metode Pembayaran
                            </h3>
                        </div>
                    </div>
                    ...
                    <dl id="paymentList" class="flex w-full flex-col space-y-4 p-4 sm:p-6 hidden"
                        ...
                        @if(Auth::check())
                            @foreach($pay_method as $p)
                                @if($p->tipe == 'SALDO')
                                    <div x-bind:class="{ 'bg-white': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                        class="relative flex cursor-pointer method-list rounded-md border border-transparent bg-murky-200 p-3 shadow-sm outline-none md:p-4 hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-800 duration-300 ease-in-out melpa-sabled disabled"
                                        role="radio" aria-checked="false" method-id="{{$p->code}}" name="paymentMethod"
                                        @click="paymentSelected = '{{$p->code}}'">
                                        <div class="flex items-center gap-2 max-w-xs"><input type="radio" id="method_92"
                                                name="paymentMethod" value="{{$p->code}}" class="peer hidden" /><label
                                                for="method_92"></label><x-optimized-image :src="$p->image_url" profile="payment_logo"
                                                alt="Coin" sizes="35px" width="35" height="40" />
                                            <div><span class="block text-xs font-semibold text-murky-800 sm:text-sm"
                                                    id="headlessui-label-:riu:">{{ $p->name }}</span>
                                                <p class="block text-xxs text-murky-800 sm:text-xs hargapembayaran" id="{{$p->code}}">Rp 0
                                                </p>
                                            </div>
                        ...
                        @foreach($pay_method as $p)
                            @if($p->isType('qris') && $p->isEnabled())
                                <div x-bind:class="{ 'bg-white bj-shadow': paymentSelected === '{{$p->code}}', 'bg-murky-200': paymentSelected !== '{{$p->code}}' }"
                                    class="relative flex cursor-pointer method-list rounded-md border border-transparent bg-murky-200 p-4 shadow-sm outline-none md:p-4 hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-800 duration-300 ease-in-out melpa-sabled disabled"
                                    role="radio" aria-checked="false" method-id="{{$p->code}}" name="paymentMethod"
                                    @click="paymentSelected = '{{$p->code}}'">
                                    <div class="flex items-center gap-2 max-w-xs">
                                        <input type="radio" id="method_{{$p->id}}" name="paymentMethod" value="{{$p->code}}"
                                            class="peer hidden" />
                                        <label for="method_{{$p->id}}"></label>
                                        <x-optimized-image :src="$p->image_url" profile="payment_logo" alt="qris" sizes="35px"
                                            width="35" height="10" />
                                        <div>
                                            <span class="block  text-xs font-semibold text-murky-800 sm:text-sm"
                                                id="headlessui-label-:riu:">{{$p->name}}</span>
                        ...
                        <div
                            class="flex w-full transform flex-col melpa-sabled disabled justify-between rounded-xl bg-murky-600 text-left text-sm font-medium text-white duration-300 focus:outline-none accordion-header">
                            <dt>
                                <button class="w-full disabled:opacity-75" id="disclosure-button-1" type="button"
                                    @click="selected !== 3 ? selected = 3 : selected = null" aria-expanded="false"
                                    aria-controls="disclosure-panel-1">
                                                ...
                                                @foreach($pay_method as $p)
                                                    @if($p->isType('e-walet') && $p->isEnabled())
                                                        ...
                                                        <div x-bind:class="{
                                                            ...
                                                            id="radio-group-{{ $p->code }}" role="radio" aria-checked="false"
                                                            method-id="{{ $p->code }}" name="paymentMethod" value="{{ $p->code }}"
                                                            tabindex="0" aria-labelledby="label-{{ $p->code }}"
                                                            aria-describedby="description-{{ $p->code }}"
                                                            @click="paymentSelected = '{{ $p->code }}'">
                                                            <input type="radio" id="method_{{ $p->id }}" name="paymentMethod"
                                                                value="{{ $p->code }}" class="peer hidden" />
                                                            ...
                                                            <span class="flex w-full">
                                                                <span class="flex w-full flex-col justify-between">
                                                                    ...
                                                                    <div class="flex w-full items-center justify-between">
                                                                        <div class="mt-1">
                                                                            <div
                                                                                class="relative z-30 mt-0 text-xs font-semibold leading-4 text-murky-800">
                                                                                <h6 class="hargapembayaran" id="{{ $p->code }}"></h6>
                                                                            </div>
                                                                        </div>
                                                                        <div class="relative aspect-[6/2] w-10">
                                                                            <img src="{{ $p->image_url }}" x-bind:class="{
                ...
                <div class="rounded-xl bg-murky-800 shadow-2xl" id="promooo">
                    ...
                    <div class="flex border-b border-murky-600">
                        <div class="flex flex-row items-center gap-1 bg-[#ffc007] text-darkColor rounded-md">
                            <div class="items-center justify-start flex bg-gradient-to-b from-murky-800 to-murky-800 clip-path-number p-4 h-12 w-16"
                                style="border-top-left-radius: 12px;"><span class="font-bold text-xl italic">4</span></div>
                            <h3 class="px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">Kode Promo</h3>
                        </div>
                    </div>
                    <div class="p-4 sm:px-6 sm:pb-6"><label for="voucher" class="block text-xs font-medium text-white pb-2">Kode
                            Promo</label>
                        <div class="flex items-center space-x-2">
                            <div class="grow">
                                <div class="flex flex-col items-start"><input
                                        ...
                                        type="text" id="voucher" name="voucher" placeholder="Masukkan Kode Promo Anda"
                                        required /></div>
                            </div><button type="button" id="btn-check"
                                class="flex items-center justify-center rounded-md bg-primary-5400 py-2 px-4 text-xs font-semibold text-white hover:bg-orange-400 disabled:cursor-not-allowed disabled:opacity-75">
                                Gunakan </button>
                        </div>
                        <button type="button" class="order-available-voucher js-available-voucher">
                ...
                <div class="rounded-xl bg-murky-800 shadow-2xl jumpToWhatsApp" id="whatsappp">
                    ...
                    <div class="flex border-b border-murky-600">
                        <div class="flex flex-row items-center gap-1 bg-[#ffc007] text-darkColor rounded-md">
                            <div class="items-center justify-start flex bg-gradient-to-b from-murky-800 to-murky-800 clip-path-number p-4 h-12 w-16"
                                style="border-top-left-radius: 12px;"><span class="font-bold text-xl italic">5</span></div>
                            <h3 class="px-2 py-2 text-base font-semibold leading-6 text-white sm:px-4">Nomor WhatsApp</h3>
                        </div>
                    </div>
                    <div class="p-4 sm:px-6"><label for="nomor" class="block text-xs font-medium text-white pb-2">Nomor
                            WhatsApp</label><input type="number" id="nomor" autocomplete="off" name="whatsapp"
                ...
                <div class="sticky inset-x-0 bottom-0 z-10 shad sticky bottom-0 rounded-md pb-4 flex flex-col gap-4 ">
                    <div class=" space-y-0">
                        <div class="rounded-lg border border-dashed bg-secondary p-2 text-sm rounded-md md:hidden initial-element"
                            style="display: flex;">
                            <div class="flex w-full flex-col space-y-0">
                                <div class="rounded-md p-4">
                                    <div class="text-center">Belum ada item produk yang dipilih.</div>
                        ...
                        <div class="rounded-lg border border-dashed bg-secondary p-2 rounded-md text-sm text-secondary-foreground md:hidden selected-element "
                            style="display: none;">
                            <div class="mb-1 aspect-square timmel-5"><x-optimized-image :src="$kategori->thumbnail"
                                    profile="thumbnail" alt="icon" sizes="80px" width="80" height="100"
                                    class="aspect-square timmel-5 rounded-lg object-cover" style="color: transparent" /></div>
                            <div class="flex w-full flex-col space-y-1 ml-3">
    ...
    <script>
        document.addEventListener("click", function (event) {
            var closeButton = event.target.closest("#closeWeeklyDiamondPopupButton");
            if (!closeButton) {
                return;
            }

            event.preventDefault();
            var popup = document.getElementById("weeklyDiamondPassPopup");
            if (!popup) {
                return;
            }
            ...
            try {
                localStorage.setItem("hideWeeklyDiamondPassPopup", "true");
            } catch (_error) {
                // noop
            }
        });
    </script>
    <div class="order-available-voucher-modal" id="availableVoucherModal" role="dialog" aria-modal="true"
        aria-labelledby="availableVoucherModalTitle" aria-hidden="true">
