@extends('template.template')
    ...
    <div class="-mt-[60px] flex min-h-screen items-center justify-center">
        <div class="text-center">
            <p class="text-base font-semibold text-primary-500">500</p>
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-white sm:text-5xl">Internal Server Error</h1>
            <p class="mt-6 text-base leading-7 text-murky-300">Sorry, something went wrong with our server. We are working to fix this issue as soon as possible. Please try again later.</p>
