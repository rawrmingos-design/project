...
class InboundWhitelistMiddlewareTest extends TestCase
{
    ...
    public function test_callback_routes_are_bound_to_inbound_whitelist_middleware(): void
    {
        ...
        $expectations = [
            ...
            ['uri' => 'ipay88/callback', 'method' => 'POST', 'middleware' => 'inbound.whitelist:payment_gateway,ipay88,log_only'],
            ['uri' => 'ipay88/backend', 'method' => 'POST', 'middleware' => 'inbound.whitelist:payment_gateway,ipay88,log_only'],
