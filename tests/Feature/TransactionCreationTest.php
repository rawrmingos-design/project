...
class TransactionCreationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        DB::table('setting_webs')->insert([
            ...
            'judul_web' => 'Test Web',
             ...
             'keyword' => 'test',
             'og_image' => 'og.png',
             'fe_color_primary' => '#000',
             'fe_color_secondary' => '#fff',
        ]);
        ...
        $this->methodTripay = Method::create([
            ...
            'code' => 'QRIS',
            'data' => 'qris',
            'payment' => 'tripay', // Matches OrderController logic
            'tipe' => 'e-wallet',
            'images' => 'qris.png',
            'status' => 'active'
        ]);
    ...
    public function user_can_create_order_using_balance()
    {
        ...
        // Mock Digiflazz response via Http facade (if OrderController calls it directly or via ProviderRouting)
        // Note: processGameProvider -> ProviderRoutingService -> DigiflazzController
        Http::fake([
        ...
        $this->assertDatabaseHas('pembelians', [
            ...
            'status' => 'Proses', // Balance payment is immediately processed
            'tipe_transaksi' => 'game'
        ]);
    ...
    public function user_cannot_create_order_with_insufficient_balance()
    {
        ...
        $response->assertStatus(200)
            ...
            // Message might be 'Saldo tidak mencukupi'
    }
    ...
    public function user_can_create_order_using_tripay()
    {
        ...
        // Since we are going to refactor TripayController to use Http, we can use Http::fake
        Http::fake([
        ...
        $this->assertDatabaseHas('pembelians', [
            'username' => $this->user->username,
            'layanan' => $this->layanan->layanan,
            'status' => 'Pending', // Tripay needs payment first
