...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
   <head>
    ...
    <meta property="og:image" content="<?php echo e(!$config ? '' : $config->logo_favicon); ?>">
    <meta name="title" content="<?php echo e(!$config ? '' : $config->judul_web); ?>">
    <meta name="keywords" content="<?php echo e(!$config ? '' : $config->keywords); ?>">
   ...
   .prose :where(ol > li):not(:where([class~=not-prose] *))::marker {
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/assets/css/pjojikhhoyutyrtd.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/assets/css/barrsopaosocas.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/assets/css/owihdagowdhqo.css')); ?>">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        $("#searchProds").keyup(function() {
            ...
            e.length < 1 ? ($(".resultsearch").removeClass("show"), $(".resultsearch li").remove()) : delay(function() {
                $.ajax({
                    url: "<?php echo e(url('/id/cari/index')); ?>",
                    method: "POST",
                    data: {
                        data: e
                    },
    ...
    <script src="<?php echo e(asset('/assets/js/oo324ddod2323sd2dd.js')); ?>"></script>
