<style>
 ...
 .rounded-\[9999px\], .rounded-full { border-radius: 9999px; } .w-1\/4 { width: 25%; } .h-1 { height: .25rem; } .bg-murky-9000 { --tw-bg-opacity: 1; background-color: #28282A; } .hover\:animate-bounce:hover { animation: bounce 1s; } .to-secondary { --tw-gradient-to: #3f3f3f; } .from-70\% { --tw-gradient-from-position: 70%; } .from-transparent { --tw-gradient-from: transparent var(--tw-gradient-from-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to); } .bg-gradient-to-b { position: relative; background-image: linear-gradient(to bottom, var(--tw-gradient-stops)); } .bg-gradient-to-b::before { content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 100%; filter: blur(0px); z-index: 1; } .mt-12 { margin-top: 3rem; } .overlay-content { position: absolute; top: 0; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 2; color: white; font-size: 2rem; } .text-followus-foreground { color: #fffdfd; } .text-xl { font-size: 1.25rem; line-height: 1.75rem; } .bg-followus-background { background-color: #737373; } .rounded-full { border-radius: 9999px; } .justify-center { justify-content: center; } .items-center { align-items: center; } .w-11 { width: 2.75rem; } .h-11 { height: 2.75rem; } .mb-mp { margin-bottom: 4rem; } 
        ...
        <div class="mt-12 bg-gradient-to-b from-transparent from-70% to-secondary"><div class="overlay-content"></div><img src="<?php echo e(!$config ? '' : $config->logo_footer); ?>" alt="<?php echo e(env('APP_NAME')); ?>" width="100" style="width: 100%; height: auto;" class="object-cover object-bottom"></div>
<footer class="bg-murky-9000 text-text-color " >
    
    <h2 id="footer-heading" class="sr-only">Footer</h2>
    <div class="container pb-8">
     <div class="pt-4 text-center">
        <p class="text-center text-sm leading-6"><?php echo e(!$config ? '' : $config->deskripsi_web); ?></p>
    </div>
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li>
                                <a href="<?php echo e(!$config ? '' : $config->url_wa); ?>" class="flex space-x-3 text-sm leading-6 text-text-color hover:text-primary-200" target="_blank" rel="noopener noreferrer" style="outline: none;">
                                   
                                    <span>Daftar Reseller </span>
                                </a>
                            </li>
                            <li>
                                <a href="https://wa.me/[REDACTED]" class="flex space-x-3 text-sm leading-6 text-text-color hover:text-primary-200" target="_blank" rel="noopener noreferrer" style="outline: none;">
                                   
                                    <span>Web Top Up </span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('docs')); ?>" class="flex space-x-3 text-sm leading-6 text-text-color hover:text-primary-200" target="_blank" rel="noopener noreferrer" style="outline: none;">
                    ...
                    <div class="mt-10 md:mt-0">
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            ...
                            <li><a class="text-sm leading-6 text-text-color hover:text-primary-200" href="<?php echo e(route('cari')); ?>" style="outline: none;">Cek Transaksi</a></li>
                            ...
                            <li><a class="text-sm leading-6 text-text-color hover:text-primary-200" href="<?php echo e(!$config ? '' : $config->url_wa); ?>" style="outline: none;">Hubungi Kami</a></li>                            
                        </ul>
                    </div>
                </div>
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    ...
                    <div class="mt-10 md:mt-0">
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li><a href="<?php echo e(!$config ? '' : $config->url_wa); ?>" class="text-sm leading-6 text-text-color hover:text-primary-200" target="_blank" rel="noopener noreferrer" style="outline: none;">WhatsApp</a></li>
                            <li><a href="<?php echo e(!$config ? '' : $config->url_ig); ?>" class="text-sm leading-6 text-text-color hover:text-primary-200" target="_blank" rel="noopener noreferrer" style="outline: none;">Instagram</a></li>
                            <li><a class="text-sm leading-6 text-text-color hover:text-primary-200" href="<?php echo e(route('policy')); ?>" style="outline: none;">Kebijakan Pribadi</a></li>
                            <li><a class="text-sm leading-6 text-text-color hover:text-primary-200" href="<?php echo e(route('terms')); ?>" style="outline: none;">Syarat & Ketentuan</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-16 border-t border-bg-color pt-8 sm:mt-20 lg:mt-24 text-center">
            <p class="text-xs leading-5 text-text-color">© <?php echo e(date("Y")); ?> <?php echo e(ENV('APP_NAME')); ?>. All rights reserved.</p>
 ...
 <!--<div class="fixed bottom-0 left-0 m-4 z-10">-->
 <!--    <div class="flex flex-col items-center gap-2">-->
 <!--        <div class="flex flex-col items-center gap-2 transition-opacity duration-300 opacity-0">-->
             
 <!--       </div>-->
 <!--       <a href="<?php echo e(!$config ? '' : $config->url_wa); ?>">-->
 <!--            <img alt="floating" src="/assets/image/LVPEDIA 1.png" class="w-24 aspect-square object-contain">-->
 <!--       </a>-->
 <!--            </div>-->
 <!--               </div>-->
 
  <a
    href="<?php echo e(!$config ? '' : $config->url_wa); ?>"
...
>
    ...
    <span class="hidden text-xs font-medium md:inline">CS <?php echo e(ENV('APP_NAME')); ?></span>
</a>

<!-- Customer Service Chat End -->
<?php /**PATH D:\Backend-game-topup\web\project\resources\views////footer.blade.php ENDPATH**/ ?>