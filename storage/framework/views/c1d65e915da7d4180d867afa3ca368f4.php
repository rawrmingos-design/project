...
<section id="hero" class="relative mb-4 bg-transparent py-4 shadow-2xl ">
    <div class="hero-swiper swiper  container ">
        <div  id="heroo"  class="swiper-wrapper ">
            <?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="swiper-slide">
                <img  src="<?php echo e($data->path); ?>" class="w-full h-auto object-cover  rounded-3xl "/>
            </div>
    ...
    <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <span class="absolute left-1/2 top-1/2 h-1 w-1 rotate-[215deg] animate-meteor-effect rounded-[9999px] bg-white shadow-[0_0_0_1px_#ffffff10] before:absolute before:top-1/2 before:h-[1px] before:w-[80px] before:-translate-y-[0%] before:transform before:bg-gradient-to-r before:from-white before:to-transparent before:content-['']"
            style="top: -20px; left: <?php echo e($position['left']); ?>px; animation-delay: <?php echo e($position['delay']); ?>s; animation-duration: <?php echo e($position['duration']); ?>s;"></span>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</section>
                                    ...
                                    <div
                                        ...
                                        <div id="special_deals">
                                            <div class="list swiper-wrapper marquee-content">
                                                <?php for($i = 0; $i < 5; $i++): ?>
                                                    <?php $__currentLoopData = $flashsale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $discount = round(
                                                                    ...
                                                                    <div class="bar">
                                                                        <div class="progress"
                                                                            ...
                                                                            <div class="progress-bar"
                                                                                style="width: <?php echo e($progress); ?>%; background-color: var(--warna_3); height: 100%;">
                                                                            </div>
                                                                        </div>

                                                                        <span class="progress-text">Tersisa:
                                                                            <?php echo e($fs->sisa_stok); ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="promo">
                                                                <div class="rate">Rp.
                                                                    <?php echo e(number_format($fs->harga_flash_sale, 0, '.', ',')); ?>

                                                                </div>
                                                                <div class="price">
                                                                    <b><del class="red-line-through">Rp.
                                                                            <?php echo e(number_format($fs->harga, 0, '.', ',')); ?></del></b>
                                                                    <figcaption class="text-sm font-bold">HEMAT Rp
                                                                        <?php echo e(number_format($fs->harga - $fs->harga_flash_sale, 0, '.', ',')); ?>
...
<?php endif; ?>  
         ...
         <p class="pl-6 text-xs">Beberapa produk yang paling populer saat ini.</p>
          ...
          <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php for($i = 0; $i < 0.01; $i+= 0.1): ?>                
                <a href="<?php echo e(url('/id')); ?>/<?php echo e($category->kode); ?>" class="melpaSlideUp" style="animation-delay: <?php echo e($i); ?>s;">
                        <div class="bg-title-product flex items-center gap-x-1.5 rounded-2xl p-1.5 duration-300 ease-in-out hover:shadow-2xl hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-800 md:gap-x-3 md:rounded-2xl md:p-3">                            
                                    <img src="<?php echo e($category->thumbnail); ?>" class="aspect-square h-14 w-14 rounded-lg !object-cover !object-center ring-1 ring-murky-600 md:h-20 md:w-20 md:rounded-xl" alt="<?php echo e($category->nama); ?>" />
                            <div
                                class="relative flex w-full flex-col">
                                <h2 class="w-[100px] truncate text-xxs font-semibold sm:w-[200px] md:w-[275px] md:text-base"> <?php echo e($category->nama); ?> </h2>
                                <p class="text-xxs md:text-sm"><?php echo e($category->sub_nama); ?></p>
                        </div>
                </div>
                </a>
             <?php endfor; ?>
 ...
 <div class="grid grid-cols-3 gap-4 sm:grid-cols-4 sm:gap-x-6 sm:gap-y-8 lg:grid-cols-5 xl:grid-cols-6" id="game">
    <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($category->tipe == "game" || $category->tipe == "populer"): ?>
        <a href="<?php echo e(url('/id/' . $category->kode)); ?>" class="melpazoom">
                                        <div class="group category-item relative overflow-hidden rounded-xl bg-muted transition-transform duration-300 ease-in-out hover:shadow-2xl hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-murky-900"
                                           ...
                                           <!-- event -->
                                            ...
                                            <!-- end event -->
                                           <div class="w-full aspect-square"><img alt="<?php echo e($category->nama); ?>" fetchpriority="high" decoding="async" data-nimg="1"
                                                    class="h-full w-full object-cover object-center"
                                                    srcset="<?php echo e($category->thumbnail); ?>"
                                                    src="<?php echo e($category->thumbnail); ?>" style="color: transparent;"></div>
                                            <div class="bg-weji neverzoom py-2">
                                                <div class="flex flex-col px-3 py-1">
                                                    <h2 class="truncate text-sm font-semibold text-foreground sm:text-base"><?php echo e($category->nama); ?></h2>
                                                    <p class="truncate text-xxs text-foreground sm:text-xs"><?php echo e($category->sub_nama); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>                                            
...
<div id="headlessui-tabs-panel-mobilelegends" role="tabpanel" aria-labelledby="headlessui-tabs-tab-mobilelegends" data-tabs-content style="display: none;">
                                    <div class="grid grid-cols-3 gap-4 sm:grid-cols-4 sm:gap-x-6 sm:gap-y-8 lg:grid-cols-5 xl:grid-cols-6 " >
                                         <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <?php if($category->tipe == "giftskin" || $category->tipe == "joki" || $category->tipe == "jokigendong" || $category->tipe == "vilogml"): ?>
                                        <a href="<?php echo e(url('/id/' . $category->kode)); ?>" class="melpazoom">
                ...
                <div @click.outside="open = false"
                    ...
                    <div class="w-full pb-4">
                        <div><img alt="" fetchpriority="high" width="0" height="0" decoding="async"
                                ...
                                srcset="<?php echo e(isset($popup->path) ? $popup->path : ''); ?>"
                                src="<?php echo e(isset($popup->path) ? $popup->path : ''); ?>"
                        ...
                        <div class="relative flex flex-col items-center pt-4 text-foreground">
                            ...
                            <div class="prose prose-sm px-4 pb-4 text-xs text-white">
                                <p class="text-center" x-html="`<?php echo isset($popup->deskripsi)
                                    ? $popup->deskripsi
...
<?php echo $__env->make('template.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Backend-game-topup\web\project\resources\views/template/id/index.blade.php ENDPATH**/ ?>